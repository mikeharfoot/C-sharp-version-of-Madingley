...
namespace Madingley
{
    ...
    public class RevisedTerrestrialPlantModel
    {
            ...
            uint currentMonth, string outputDetail, bool specificLocations)
        {
            ...
            uint monthOfYear = currentMonth % 12;
            ...
            if (deciduous)
            {
                ...
                AnnualLeafMortRate = this.CalculateDeciduousAnnualLeafMortality(cellEnvironment["AnnualTemperature"][monthOfYear]);
                ...
                {
                    TempDev[i-(year*12)] = cellEnvironment["Temperature"][i] - cellEnvironment["AnnualTemperature"][monthOfYear];
            ...
            else
            {
                ...
                AnnualLeafMortRate = this.CalculateEvergreenAnnualLeafMortality(cellEnvironment["AnnualTemperature"][currentMonth]);
            ...
            // Calculate fine root mortality rate
            double AnnualFRootMort = this.CalculateFineRootMortalityRate(cellEnvironment["Temperature"][monthOfYear]);
            ...
            // Calculate the fractional allocation of NPP to evergreen plant matter
            double FracEvergreen = this.CalculateFracEvergreen(cellEnvironment["Fraction Year Frost"][monthOfYear]);
            ...
            // Calculate the fire mortality rate
            double FireMortRate = this.CalculateFireMortalityRate(NPP, cellEnvironment["Fraction Year Fire"][monthOfYear]);

            // Calculate the structural mortality rate
            double StMort = this.CalculateStructuralMortality(cellEnvironment["AET"][monthOfYear] * 12);
